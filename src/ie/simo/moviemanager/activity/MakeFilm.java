...
public class MakeFilm extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		makeOwn.setOnClickListener(notImplYetListener);
    }
    
    @Override
    public void onClick(View target) {
    	
    	intent = new Intent(getBaseContext(), GetDirector.class);
        if (target == script1)
